...
train_dataset = torchvision.datasets.ImageFolder(root='./Animals/animals/train', 
...
test_dataset = torchvision.datasets.ImageFolder(root='./Animals/animals/val',
                                             transform=data_transforms)
...
for param in net.parameters():
    #отключаем градиент, чтобы веса не менялись
